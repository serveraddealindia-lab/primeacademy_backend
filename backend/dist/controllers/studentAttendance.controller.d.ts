...
export declare const breakIn: (req: AuthRequest, res: Response) => Promise<void>;
export declare const breakOut: (req: AuthRequest, res: Response) => Promise<void>;
declare const _default: {
    ...
    breakIn: (req: AuthRequest, res: Response) => Promise<void>;
    breakOut: (req: AuthRequest, res: Response) => Promise<void>;
};
