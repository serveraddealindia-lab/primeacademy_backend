...
const employeeLeaveController = __importStar(require("../controllers/employeeLeave.controller"));
const auth_middleware_1 = require("../middleware/auth.middleware");
const User_1 = require("../models/User");
const router = (0, express_1.Router)();
// POST /api/employee-leaves - Create leave request
router.post('/', auth_middleware_1.verifyTokenMiddleware, employeeLeaveController.createLeave);
// GET /api/employee-leaves - Get all leave requests
router.get('/', auth_middleware_1.verifyTokenMiddleware, employeeLeaveController.getLeaves);
